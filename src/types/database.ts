...
export type BrandCategory = ProductCategory | "mounting_structure" | "accessory";
...
import type { SolarJourneyLifecycle, SolarJourneyMilestone } from "../../../backend-development/supabase/contracts/solarJourneyMilestones";
