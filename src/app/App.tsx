...
export function App() {
  return <Routes><Route path="/login" element={<LoginPage />} /><Route element={<ProtectedRoute />}><Route element={<AppShell />}><Route index element={<DashboardPage />} /><Route path="/products" element={<ProductsPage />} /><Route path="/accessories" element={<AccessoriesPage />} /><Route path="/products/price-manager" element={<ProductPriceManagerPage />} /><Route path="/admin/products/price-manager" element={<ProductPriceManagerPage />} /><Route path="/brands" element={<BrandsPage />} /><Route path="/package-configuration" element={<PackageConfigurationPage />} /><Route path="/recommendation-rules" element={<RecommendationRulesPage />} /><Route path="/promo-codes" element={<PromoCodesPage />} /><Route path="/package-preview" element={<Navigate to="/package-configuration" replace />} /><Route path="/compatibility" element={<Navigate to="/package-configuration" replace />} /><Route path="/users" element={<UsersPage />} /><Route path="/bookings" element={<BookingsPage />} /><Route path="/premium-care" element={<PremiumCarePage />} /><Route path="/smart-tools" element={<SmartToolsPage />} /></Route></Route><Route path="*" element={<Navigate to="/" replace />} /></Routes>;
}
